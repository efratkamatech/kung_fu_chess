...
password), then lets you press "Play" to be matched with an opponent of similar
rating. Once matched it opens the window, which draws whatever the server sends and
turns your clicks into move commands.
"""
